...
public class KafkaConsumerConfigs {
    ...
    private Object useHeadersifPresent;
    ...
    public ConsumerFactory<String, CarPostDTO> consumerFactory() {
        ...
        //props.put(JsonDeserializer.None,"*");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);

        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(),
                new org.springframework.kafka.support.serializer.JsonDeserializer<>(CarPostDTO.class, false));
